...
## 將 ATA 更新至 1.6 版
> [!NOTE]
> 如果您的環境中沒有安裝 ATA，請下載包括 1.6 版的完整版本 ATA，並遵循 [Install ATA](/advanced-threat-analytics/deploy-use/install-ata) (安裝 ATA) 所述的標準安裝程序.
...
2.  執行安裝檔案 Microsoft ATA Center Setup.exe，並遵循螢幕上的指示安裝更新。
    ...
    5.在 [歡迎] 頁面中選取您的語言，然後按一下 [下一步].

    6.  閱讀使用者授權合約，如果您接受條款，請按一下 [下一步].

    7.  您現在可以使用 Microsoft Update 讓 ATA 保持最新狀態。  在 [Microsoft Update] 頁面中選取 [當我檢查更新時使用 Microsoft Update (建議選項)]。.
...
1.  在每個 ATA 閘道上，解壓縮 ATA 閘道套件的檔案，執行 **Microsoft ATA Gateway Setup.exe** 檔案.
