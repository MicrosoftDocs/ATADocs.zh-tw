...
> - 作為虛擬機器執行時不支援動態記憶體或任何其他記憶體佔用功能。 如需以虛擬機器執行 ATA 中心的詳細資訊, 請參閱[Ata 中心需求](https://docs.microsoft.com/advanced-threat-analytics/ata-prerequisites#ata-center-requirements)
