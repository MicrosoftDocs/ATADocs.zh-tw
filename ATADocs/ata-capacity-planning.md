...
&#42;&#42;平均數目 (尖峰數目)
> [!NOTE]
> - ATA 中心可以從所有受監視的網域控制站，處理每秒最多100百萬封包。 在某些環境中，相同的 ATA 中心可以處理高於1M 的整體流量，而某些環境可能會超過 ATA 容量。 請洽詢我們， azureatpfeedback@microsoft.com 以取得規劃和預估大型環境的協助。
...
|ATA 輕量型閘道|不需要專用的伺服器及連接埠鏡像設定|Lower|安裝在網域控制站上|每秒支援最多 10,000 個封包|
