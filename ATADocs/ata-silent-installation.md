...
>|CenterCertificateThumbprint|CenterCertificateThumbprint="<CertThumbprint>"|否|設定 ATA 中心的憑證指紋。 此憑證是用來保護 ata 閘道與 ATA 中心的通訊，以及驗證 ATA 主控台網站的身分識別。 如果未設定，安裝會產生自我簽署憑證。|

**範例**：

若要使用預設安裝路徑和使用者定義的憑證指紋來安裝 ATA 中心：
