---
title: 1.6 遷移指南的 Advanced 威脅分析更新
...
> [!NOTE] 
> 如果您的環境中未安裝 ATA，請下載包含1.6 版的 ATA 完整版本，並遵循 [安裝 ATA](install-ata-step1.md)中所述的標準安裝程式。
...
1. 執行安裝檔案 Microsoft ATA Center Setup.exe，並遵循螢幕上的指示安裝更新。
...
1. 系統會保留您先前的設定，但是可能需要幾分鐘的時間讓服務重新啟動。
