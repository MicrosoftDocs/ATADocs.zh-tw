...
4. 按兩下 [設定目標訂閱管理員]。
   ...
   3.  在 [SubscriptionManagers] 下方，輸入下列值，然後按一下 [確定]：*Server=http://<fqdnATAGateway>:5985/wsman/SubscriptionManager/WEC,Refresh=10* 
      
        *(例如：伺服器 =`http://atagateway9.contoso.com:5985/wsman/SubscriptionManager/WEC,Refresh=10`)*
