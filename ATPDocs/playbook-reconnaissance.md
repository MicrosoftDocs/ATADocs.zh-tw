...
[一個已完成的 ATP 安全性警示實驗室](playbook-setup-lab.md)
...
為了示範常見的「目錄服務」偵察方法，我們將使用原生 Microsoft 二進位檔 *net*。 在我們的嘗試之後，檢查 JeffL (我們的遭盜用使用者) 的「活動」時間軸將會顯示 Azure ATP 正在偵測此活動。
...
> [Azure ATP 橫向移動劇本](playbook-lateral-movement.md)
