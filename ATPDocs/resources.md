...
- [ATP 容量規劃指南](capacity-planning.md)
...
- [Azure ATP 設定](install-step1.md)遵循下列步驟在您的環境中部署 Azure ATP。
- [將 Azure ATP 與 Microsoft Defender ATP 整合](integrate-msde.md)
...
- [Azure ATP 常見問題集](technical-faq.md) - 本文提供有關 Azure ATP 的常見問題清單，並提供深入解析和答案。
...
私人社群：[Azure ATP Yammer 群組](https://www.yammer.com/azureadvisors/#/threads/inGroup?type=in_group&feedId=9386893&view=all&preserve-view=true)
