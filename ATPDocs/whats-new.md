...
如需舊版 Azure ATP 的詳細資料，直到 (並包含) 2.55 版，請參閱 [Azure ATP 版本參考](release-reference.md)。
...
如需 2.55 版 (包含 2.55 版) 之前每個 Azure ATP 版本的詳細資料，請參閱 [Azure ATP 版本參考](release-reference.md)。
